...
Vendored copy of the [Codicons](https://github.com/microsoft/vscode-codicons) icon font for use with glsysmon.

## Source

- Repository: https://github.com/microsoft/vscode-codicons
- NPM package: [@vscode/codicons](https://www.npmjs.com/package/@vscode/codicons)
- Version: `0.0.46-24` (font version `1.15`)
- Original file: `dist/codicon.ttf` (vendored as `codicon.ttf`)

## Contents

- `codicon.ttf` — The icon font for Visual Studio Code (TrueType, 11 tables, 149508 bytes)
- `LICENSE` — Creative Commons Attribution 4.0 International (CC-BY-4.0) for documentation and icon content
- `LICENSE-CODE` — MIT License for code
- `README.md` — This file (vendoring notes + upstream README below)

Only the TTF is vendored; the CSS, SVG, CSV, and other distributables are omitted.

## License

Microsoft and contributors grant a license to the documentation and other content (including the font) under the [Creative Commons Attribution 4.0 International Public License](https://creativecommons.org/licenses/by/4.0/legalcode), see [LICENSE](LICENSE), and grant a license to any code under the [MIT License](https://opensource.org/licenses/MIT), see [LICENSE-CODE](LICENSE-CODE).
...
```sh
npm pack @vscode/codicons
tar -xzf vscode-codicons-*.tgz
cp package/dist/codicon.ttf dep/codicons/codicon.ttf
cp package/LICENSE dep/codicons/LICENSE
cp package/LICENSE-CODE dep/codicons/LICENSE-CODE
```
